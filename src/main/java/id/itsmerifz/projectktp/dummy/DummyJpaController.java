...
import id.itsmerifz.projectktp.dummy.exceptions.NonexistentEntityException;
import id.itsmerifz.projectktp.dummy.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("id.itsmerifz_projectktp_jar_0.0.1-SNAPSHOTPU");
